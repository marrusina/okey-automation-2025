//Класс Platform, реализация Синглтона платформы, методы изъятия системной
//переменной Platform и сравнения ее с заданным значением, метод установки
//драйвера в зависимости от заданной переменной
package lib;
